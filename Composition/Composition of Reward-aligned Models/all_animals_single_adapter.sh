...
do
    for adapter in "aesthetic" "pickscore" "hps" "imagereward" "mps"
        do
        accelerate launch train_dreambooth_lora_new.py \
            --pretrained_model_name_or_path="runwayml/stable-diffusion-v1-5" \
            --instance_data_dir="dog" \
            --load_model_dir="output_test/" \
            --adapters="/home/ubuntu/cdf/implementations/AlignProp/checkpoints/adapters/$adapter/epochs_10" \
            --validation_rewards="$adapter" \
